...
(function(window, document, $) {
    ...
    $(window).on('load',function(){
        ...
        $('a[data-action="open"]').on('click',function(){          
            $(this).closest('.card-collapse').toggleClass('collapse in collapse');
            $(this).find('.form').trigger("reset");          
            $("input[type=hidden]").val('');      

            var $this = $(this),
            href = $this.attr('href');
            $(href).addClass('collapse collapse in');   
            $(href).find('.form').trigger("reset");  
